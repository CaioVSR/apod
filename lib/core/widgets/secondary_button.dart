...
/// The [SecondaryButton] is a class that contains the primary button of the
/// application.
class SecondaryButton extends StatelessWidget {
  /// The default constructor of the [SecondaryButton] class.
  ...
  Widget build(BuildContext context) {
    return TextButton(
      ...
      style: ButtonStyle(
        ...
        foregroundColor: MaterialStatePropertyAll(_theme.colors.primary),
